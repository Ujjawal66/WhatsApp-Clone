...
chats[0].setMsg("I make this Whatsapp clone", false, "4:80 pm");
chats[0].setMsg("Ok Ok", true, "4:80 pm");
chats[0].setMsg("Actually, I am CEO of Google", true, "4:80 pm");
chats[0].setMsg("And, I am very Impressed by your skill and wants to Hire you", true, "4:80 pm");
chats[0].setMsg("Yes, Ofcourse I also want an job", false, "4:80 pm");
chats[0].setMsg("I just need little push and I will be a great employee", false, "4:80 pm");
chats[0].setMsg("Yes,Why not", true, "4:80 pm");
chats[0].setMsg("Can, You send me your Resume", true, "4:80 pm");
chats[0].setMsg("Wait", false, "4:80 pm");
chats[0].setMsg(760, false, "4:80 pm");
chats[0].setMsg("I like it", true, "4:80 pm");

chats[1].setMsg(`Mene Itachi DEkha hai ghumta hua`, true, "4:80 pm");
chats[1].setMsg(`Tumhe pta hai kya ITACHI kha milega???`, false, "4:80 pm");

chats[2].setMsg(`Need you to make it X`, false, "4:80 pm");
chats[2].setMsg(`On it`, true, "4:80 pm");
chats[2].setMsg(`And when you say make it X, just to clarify, you mean...`, true, "4:80 pm");
